...
{{--  Maj:2/06/2013 - backend.php --}}

{{-- Page title --}}
@section('title')
{{Lang::get('backend.users.create.section-title')}}
@parent
@stop
...
<div class="page-header">
	<h3>
		{{Lang::get('backend.users.create.page-title')}}

		<div class="pull-right">
			<a href="{{ route('users') }}" class="btn btn-small btn-inverse"><i class="icon-circle-arrow-left icon-white"></i> {{Lang::get('backend.users.create.buttons.back')}}</a>
		</div>
	</h3>
</div>
...
<ul class="nav nav-tabs">
	<li class="active"><a href="#tab-general" data-toggle="tab">{{Lang::get('backend.users.create.tabs.general')}}</a></li>
	<li><a href="#tab-permissions" data-toggle="tab">{{Lang::get('backend.users.create.tabs.permissions')}}</a></li>
</ul>
...
<form class="form-horizontal" method="post" action="" autocomplete="off">
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="control-group {{ $errors->has('first_name') ? 'error' : '' }}">
				<label class="control-label" for="first_name">{{Lang::get('backend.users.create.first_name')}}</label>
				<div class="controls">
			...
			<div class="control-group {{ $errors->has('last_name') ? 'error' : '' }}">
				<label class="control-label" for="last_name">{{Lang::get('backend.users.create.last_name')}}</label>
				<div class="controls">
			...
			<div class="control-group {{ $errors->has('email') ? 'error' : '' }}">
				<label class="control-label" for="email">{{Lang::get('backend.users.create.email')}}</label>
				<div class="controls">
			...
			<div class="control-group {{ $errors->has('password') ? 'error' : '' }}">
				<label class="control-label" for="password">{{Lang::get('backend.users.create.password')}}</label>
				<div class="controls">
			...
			<div class="control-group {{ $errors->has('password_confirm') ? 'error' : '' }}">
				<label class="control-label" for="password_confirm">{{Lang::get('backend.users.create.confirm-password')}}</label>
				<div class="controls">
			...
			<div class="control-group {{ $errors->has('activated') ? 'error' : '' }}">
				<label class="control-label" for="activated">{{Lang::get('backend.users.create.activated')}}</label>
				<div class="controls">
			...
			<div class="control-group {{ $errors->has('groups') ? 'error' : '' }}">
				<label class="control-label" for="groups">{{Lang::get('backend.users.create.groups')}}</label>
				<div class="controls">
					...
					<span class="help-block">
						{{Lang::get('backend.users.create.help')}}
					</span>
				</div>
			</div>
		</div>
	...
	<div class="control-group">
		<div class="controls">
			<a class="btn btn-link" href="{{ route('users') }}">{{Lang::get('backend.users.create.buttons.cancel')}}</a>

			<button type="reset" class="btn">{{Lang::get('backend.users.create.buttons.reset')}}</button>

			<button type="submit" class="btn btn-success">{{Lang::get('backend.users.create.buttons.submit')}}</button>
		</div>
	</div>
</form>
@stop
