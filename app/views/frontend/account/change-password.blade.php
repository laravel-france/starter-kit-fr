...
{{-- Page title --}}
@section('title')
{{Lang::get('frontend.account.change-password.section-title')}}
@stop

{{-- Account page content --}}
@section('account-content')
<div class="page-header">
	<h4>{{Lang::get('frontend.account.change-password.page-title')}}</h4>
</div>
...
<form method="post" action="" class="form-horizontal" autocomplete="off">
	...
	<div class="control-group{{ $errors->first('old_password', ' error') }}">
		<label class="control-label" for="old_password">{{Lang::get('frontend.account.change-password.old-password')}}</label>
		<div class="controls">
	...
	<div class="control-group{{ $errors->first('password', ' error') }}">
		<label class="control-label" for="password">{{Lang::get('frontend.account.change-password.password')}}</label>
		<div class="controls">
	...
	<div class="control-group{{ $errors->first('password_confirm', ' error') }}">
		<label class="control-label" for="password_confirm">{{Lang::get('frontend.account.change-password.confirm-password')}}</label>
		<div class="controls">
	...
	<div class="control-group">
		<div class="controls">
			<button type="submit" class="btn btn-primary">{{Lang::get('frontend.account.change-password.submit')}}</button>

			<a href="{{ route('forgot-password') }}" class="btn btn-link">{{Lang::get('frontend.account.change-password.forgot-password')}}</a>
		</div>
	</div>
</form>
@stop
